...
public class test {
	...
	
	{
		  ...
		  Campaign campaign1=new Campaign(3, "Bilgisayar", "Mayis", "Haziran", 1500);
	      ...
	      Client client1 = new Client(1, "celebiler", "kızıltoprak", "ceren",campaignlist1);
		  Client client2 = new Client(2, "sanverler", "Acibadem", "onur",campaignlist2);
